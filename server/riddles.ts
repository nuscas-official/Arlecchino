...
export const riddles: Riddle[] = [
  ...
  {
    prompt: 'In the Fate Grand Order community, the “minimum” suggested investment required for Space Ereshkigal to perform omnicore (A setup centered around supporting a single servant) farming is NP3, Level 110-120, 2K Fou attack.\n\nWhich of the following reasons explain why Space Ereshkigal has a high minimum investment requirement?',
    options: [
      { key: 'a', label: 'She has bad class interactions with most farming content and thus requires extra stats to brute force the looping' },
      { key: 'b', label: 'She requires the extra servant coins to unlock Append 2 and Append 5' },
      { key: 'c', label: 'Omnicore looping inherently requires individual servants to have higher vertical investment.' },
      { key: 'd', label: 'All of the above' },
    ],
    correctKey: 'd',
  },
  ...
  {
    prompt: "What is the level completion if you lose to Remilia Scarlet’s final spellcard “Scarlet Gensokyo” in Touhou EoSD?",
    options: [
      { key: 'a', label: '99.58%' },
      { key: 'b', label: '99.61%' },
      { key: 'c', label: '99.64%' },
  ...
  },
  {
    ...
    options: [
      ...
      { key: 'd', label: 'Only if you fail to submit a valid excuse letter' },
    ],
    correctKey: 'a',
  },
  {
  ...
  {
    prompt: 'In Limbus Company, assuming a full 5 floor Mirror Dungeon clear with any configuration of normal/hard floors (EG F1-F3 Normal + F4-F5 hard or F1-F5 Hard), which team is statistically the fastest for Mirror Dungeon Farming?',
    options: [
      { key: 'a', label: 'Rupture (Any variant)' },
      { key: 'b', label: 'Burn (Any variant)' },
      { key: 'c', label: 'House of Spiders Ryoshu sacrifice team (6 sacrifices)' },
      { key: 'd', label: 'Fell Bullet Spam' },
    ],
    correctKey: 'd',
  },
  {
  ...
  {
    prompt: 'In Arknights, Saria is a popular SP "battery" due to her talent "Refreshment", which restores SP to nearby allies.\n\nWhat is the activation condition for "Refreshment"?',
    options: [
      { key: 'a', label: 'Saria activates one of her own skills that consumes SP' },
      { key: 'b', label: "Saria restores a nearby ally's HP" },
      { key: 'c', label: 'Saria has been blocking an enemy for 10 seconds' },
      { key: 'd', label: 'A nearby ally defeats an enemy' },
    ],
    correctKey: 'b',
  },
  {
  ...
  },
  {
    prompt: 'Luck test :D',
    options: [
      { key: 'a', label: 'I choose this' },
      { key: 'b', label: 'Feeling this' },
      { key: 'c', label: 'Definitely this' },
      { key: 'd', label: 'All in' },
    ],
    correctKey: 'b',
  },
  ...
  {
    prompt: 'Who was the Japanese Emperor during the Taisho Era?',
    options: [
      { key: 'a', label: 'Emperor Taisho' },
      { key: 'b', label: 'Emperor Meiji' },
      { key: 'c', label: 'Emperor Showa' },
      { key: 'd', label: 'Emperor Heisei' },
    ],
    correctKey: 'a',
  },
  {
  ...
  {
    prompt: 'In Clash Royale, which deck archetype revolves around forcing out an opponent’s cheap spells using low-cost swarms?',
    options: [
      { key: 'a', label: 'Log Bait' },
      { key: 'b', label: 'Bridge Spam' },
      { key: 'c', label: 'Beatdown' },
      { key: 'd', label: 'Siege' },
    ],
    correctKey: 'a',
  },
